...
PRODUCTS = [
    ...
    {"name": "Ведро пластиковое пищевое 20 л с крышкой", "desc": "Б/У, из-под сиропа, идеальное состояние, без сколов, трещин и запаха. Толстый пластик (1 кг), герметичная крышка, пищевой пластик.", "price": 300.0}   # ← цена исправлена
]
...
def main():
    ...
    print("✅ Бот запущен (с памятью диалога)")

    dialogs = {}  # словарь для хранения истории каждого пользователя
    ...
    for event in longpoll.listen():
        if event.type == VkEventType.MESSAGE_NEW and event.to_me:
            ...
            dialogs[uid] = new_history  # сохраняем обновлённую историю
